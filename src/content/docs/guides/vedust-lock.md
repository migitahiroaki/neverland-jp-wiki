...
報酬はepoch(日本時間で毎週木曜日、午前9時)という単位が満了時点でのveDUSTパワーに対し、比例配分されます。

たとえば、報酬プールが10K USDC、あなたのプール内シェアが0.1%だとしたら、epoch満了の報酬は 10 USDC となります。
...
:::tip
ペナルティ(残存期間に比例、最大75%)を支払い、ロックを解除することができます。
